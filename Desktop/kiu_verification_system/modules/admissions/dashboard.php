...
<div class="dashboard">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card stat-success">
            <div class="stat-icon"><?php echo ui_icon('calendar'); ?></div>
            <div class="stat-content">
        ...
        <div class="card-body">
            <div class="quick-actions">
                ...
                <a href="#pending-cards" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('card'); ?></span>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($card['pdf_path'])): ?>
                                        <a href="<?php echo BASE_URL; ?>download_green_card.php?id=<?php echo (int)$card['card_id']; ?>&mode=card&ts=<?php echo time(); ?>" 
                                           class="btn btn-sm btn-info" target="_blank">View Green Card</a>
                                    <?php else: ?>
