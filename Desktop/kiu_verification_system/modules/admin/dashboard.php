...
<div class="dashboard">
    ...
    <div class="stats-grid">
        <div class="stat-card stat-primary">
            <div class="stat-icon"><?php echo ui_icon('users'); ?></div>
        ...
        <div class="stat-card stat-success">
            <div class="stat-icon"><?php echo ui_icon('student'); ?></div>
            <div class="stat-content">
        ...
        <div class="stat-card stat-info">
            <div class="stat-icon"><?php echo ui_icon('document'); ?></div>
            <div class="stat-content">
        ...
        <div class="stat-card stat-warning">
            <div class="stat-icon"><?php echo ui_icon('card'); ?></div>
            <div class="stat-content">
        ...
        <div class="card-body">
            <div class="quick-actions">
                <a href="users.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('users'); ?></span>
                    <span>Manage Users</span>
                </a>
                <a href="data_management.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('document'); ?></span>
                    <span>Data Management</span>
                </a>
                <a href="system_settings.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('settings'); ?></span>
                    <span>System Settings</span>
                </a>
                <a href="intakes.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('calendar'); ?></span>
                    <span>Manage Intakes</span>
                </a>
                <a href="reports.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('chart'); ?></span>
                    <span>Generate Reports</span>
                </a>
                <a href="green_card_search.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('search'); ?></span>
                    <span>Green Card Search</span>
                </a>
                <a href="system_health.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('health'); ?></span>
                    <span>System Health</span>
                </a>
                <a href="audit_logs.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('audit'); ?></span>
                    <span>Audit Logs</span>
                </a>
                <a href="backup.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('backup'); ?></span>
                    <span>Backup System</span>
                </a>
                <a href="notifications.php" class="action-btn">
                    <span class="action-icon"><?php echo ui_icon('mail'); ?></span>
