    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="quick-actions">
                <a class="action-btn" href="?download=summary"><span class="action-icon"><?php echo ui_icon('pin'); ?></span><span>Download Summary CSV</span></a>
                <a class="action-btn" href="?download=users"><span class="action-icon"><?php echo ui_icon('users'); ?></span><span>Download Users CSV</span></a>
                <a class="action-btn" href="?download=audit"><span class="action-icon"><?php echo ui_icon('audit'); ?></span><span>Download Audit CSV</span></a>
            </div>
        </div>
    </div>
</div>
