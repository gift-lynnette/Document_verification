...
<div class="dashboard">
    ...
    <div class="stats-grid">
        <div class="stat-card stat-warning">
            <div class="stat-icon"><?php echo ui_icon('clock'); ?></div>
        ...
        <div class="stat-card stat-info">
            <div class="stat-icon"><?php echo ui_icon('search'); ?></div>
            <div class="stat-content">
        ...
        <div class="stat-card stat-success">
            <div class="stat-icon"><?php echo ui_icon('check'); ?></div>
            <div class="stat-content">
        ...
        <div class="stat-card stat-danger">
            <div class="stat-icon"><?php echo ui_icon('reject'); ?></div>
            <div class="stat-content">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php foreach ($submissions as $submission): ?>
                                <tr class="<?php echo in_array($submission['status'], ['admissions_approved', 'pending_finance', 'under_finance_review', 'finance_pending']) ? 'finance-row-actionable' : ''; ?>"
                                    <?php if (in_array($submission['status'], ['admissions_approved', 'pending_finance', 'under_finance_review', 'finance_pending'])): ?>
                                        data-href="verify_payment.php?id=<?php echo (int)$submission['submission_id']; ?>"
                                    <?php endif; ?>>
                                    ...
                                    <td><?php echo format_currency($submission['payment_amount_ocr'] ?? $submission['payment_amount'] ?? 0, $submission['payment_currency'] ?? PAYMENT_CURRENCY); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if (in_array($submission['status'], ['admissions_approved', 'pending_finance', 'under_finance_review', 'finance_pending'])): ?>
                                            <a href="verify_payment.php?id=<?php echo (int)$submission['submission_id']; ?>" 
...
<style>
.module-finance .finance-row-actionable {
    cursor: pointer;
}

.module-finance .finance-row-actionable:hover {
    background: #f3fbf6;
}

.module-finance .finance-row-actionable td,
.module-finance .finance-row-actionable a,
.module-finance .filter-form,
.module-finance .filter-form * {
    position: relative;
    z-index: 5;
...
.module-finance .table-responsive,
.module-finance .table,
.module-finance .card-body {
    overflow: visible;
}
</style>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.finance-row-actionable').forEach(function(row) {
