...
define('SECURE_UPLOAD_DIR', SITE_ROOT . '/system/private_uploads/');
define('DOCUMENT_UPLOAD_MAX_SIZE', 5242880); // 5MB
define('PASSPORT_PHOTO_MAX_SIZE', 2097152); // 2MB
define('BANK_SLIP_UPLOAD_MAX_SIZE', 5242880); // 5MB
define('ALLOWED_IMAGE_TYPES', ['image/jpeg', 'image/png', 'image/jpg']);
define('ALLOWED_DOCUMENT_TYPES', ['application/pdf', 'image/jpeg', 'image/png']);
define('ALLOWED_UPLOAD_EXTENSIONS', ['pdf', 'jpg', 'jpeg', 'png']);
